...
const bgRegex = /\b(bg-slate-50|bg-slate-800|bg-slate-900|bg-white|bg-\[var\(--paper\)\]|bg-ink|bg-slate-100)\b/g;

files.forEach(file => {
  let content = fs.readFileSync(file, 'utf8');
  let original = content;
  
  // Find top level wrappers which are usually <section> or <div className="... min-h-screen">
