    ...
    >
      <div className="pt-32 pb-24 bg-transparent min-h-screen">
        <div className="container max-w-3xl mx-auto">
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-tx-primary mb-4">Terms of Service</h1>
          ...
          <div className="prose prose-slate prose-lg max-w-none text-tx-secondary font-medium leading-relaxed">
            <h2 className="text-2xl font-bold text-tx-primary mt-10 mb-4">1. Agreement to Terms</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-tx-primary mt-10 mb-4">2. Intellectual Property Rights</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-tx-primary mt-10 mb-4">3. User Representations</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-tx-primary mt-10 mb-4">4. Subscriptions and Payments</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-tx-primary mt-10 mb-4">5. Contact Information</h2>
            <p className="mb-6">
